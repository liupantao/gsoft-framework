...
import com.gsoft.framework.jpa.dao.impl.DaoFactoryBean;
...
@Documented
@Inherited
@Import(JpaDaosRegistrar.class)
public @interface EnableJpaDaos {
	 ...
	 * @return
	 */
	Class<?> repositoryFactoryBeanClass() default DaoFactoryBean.class;
	 ...
	 * repositories. Defaults to {@literal true}. If disabled, repositories must
	 * be used behind a facade that's configuring transactions (e.g. using
	 * Spring's annotation driven transaction facilities) or repository methods
	 * have to be used to demarcate transactions.
	 * 
	 * @return whether to enable default transactions, defaults to
	 *         {@literal true}.
	 */
