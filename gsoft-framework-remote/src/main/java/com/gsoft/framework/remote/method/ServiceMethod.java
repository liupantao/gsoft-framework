...
public class ServiceMethod {
	...
	private ServiceMethod resolvedFromHandlerMethod;
	 ...
	 */
	private ServiceMethod(ServiceMethod handlerMethod, Object handler) {
		Assert.notNull(handlerMethod, "HandlerMethod is required");
	 ...
	 */
	public ServiceMethod getResolvedFromHandlerMethod() {
		return this.resolvedFromHandlerMethod;
	}

	/**
	 * If the provided instance contains a bean name rather than an object instance,
	 * the bean name is resolved before a {@link ServiceMethod} is created and returned.
	 */
	public ServiceMethod createWithResolvedBean() {
		...
		return new ServiceMethod(this, handler);
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ServiceMethod)) {
			return false;
		}
		ServiceMethod otherMethod = (ServiceMethod) other;
	...
	protected class HandlerMethodParameter extends SynthesizingMethodParameter {
		...
		public <T extends Annotation> boolean hasMethodAnnotation(Class<T> annotationType) {
			return ServiceMethod.this.hasMethodAnnotation(annotationType);
		}
