...
import com.gsoft.framework.remote.method.resolver.ConditionsServiceMethodArgumentResolver;
import com.gsoft.framework.remote.method.resolver.DomainCollectionServiceMethodArgumentResolver;
import com.gsoft.framework.remote.method.resolver.DomainServiceMethodArgumentResolver;
import com.gsoft.framework.remote.method.resolver.MapServiceMethodArgumentResolver;
import com.gsoft.framework.remote.method.resolver.OrdersServiceMethodArgumentResolver;
import com.gsoft.framework.remote.method.resolver.PagerServiceMethodArgumentResolver;
import com.gsoft.framework.remote.method.resolver.ParamServiceMethodArgumentResolver;
import com.gsoft.framework.remote.method.resolver.PubContextServiceMethodArgumentResolver;
import com.gsoft.framework.remote.method.resolver.ReqContextServiceMethodArgumentResolver;
import com.gsoft.framework.remote.method.resolver.ReqParamMapServiceMethodArgumentResolver;
import com.gsoft.framework.remote.method.resolver.ServiceMethodArgumentResolverComposite;

public class InvocableSeriveMethod extends HandlerMethod {
	...
	public InvocableSeriveMethod(Object bean, Method method) {
		...
		argumentResolvers.addResolver(new ReqParamMapServiceMethodArgumentResolver());
	 ...
	 */
	public InvocableSeriveMethod(HandlerMethod handlerMethod) {
		super(handlerMethod);
	}
