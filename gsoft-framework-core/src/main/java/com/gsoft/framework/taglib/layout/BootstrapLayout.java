...
import com.gsoft.framework.taglib.layout.Panel;
...
public class BootstrapLayout extends AbstractLayout {
	...
	public String getStartHtml(PageContext pageContext) {
		...
		// script
		htmls.append("<script>$(function(){$('body',document).bootstrapLayout({").append("});").append("});</script>");
		...
		if (bodyPanel != null) {
			...
			/**
			 * <div class="main-navigator"> <div class="main-navigator-right">
			 * <div id="system-title" class="main-navigator-content"></div>
			 * </div> </div>
			 * 
			 * <div class="main-body"> <div class="main-body-right"> body内容
			 * </div> </div>
			 * 
			 * <div class="main-footer"> <div class="main-footer-right"> <div
			 * class="main-footer-content"></div> </div> </div>
			 * 
			 */
		}
	...
	protected String buildContentPrefix() {
		StringBuffer htmls = new StringBuffer();
		htmls.append("<div class=\"main-header\">").append(" 	<div class=\"main-header-right\">")
				.append("		<div class=\"main-header-content\"></div>").append("	</div>").append("</div>")
				.append("<div class=\"main-body\">").append("	<div class=\"main-body-right\">")
	...
	protected String buildContentPostfix() {
		StringBuffer htmls = new StringBuffer();
		htmls.append("	</div></div>").append("</div>").append("<div class=\"main-footer\">")
				.append("	<div class=\"main-footer-right\">").append("		<div class=\"main-footer-content\"></div>")
