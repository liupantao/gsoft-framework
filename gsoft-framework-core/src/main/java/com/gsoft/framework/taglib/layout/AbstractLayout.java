...
import com.gsoft.framework.taglib.resource.Resources;
...
public abstract class AbstractLayout {
	...
	protected String acquireString(PageContext pageContext, String context, String url) throws IOException, JspException {
		boolean isAbsoluteUrl = isAbsoluteUrl(url);
		if (isAbsoluteUrl) {//
			// for absolute URLs, delegate to our peer
			BufferedReader r = new BufferedReader(acquireReader(pageContext, context, url, isAbsoluteUrl));
	...
	private class ImportResponseWrapper extends HttpServletResponseWrapper {
		...
		private ServletOutputStream sos = new AbstractLayout.LayoutServletOutputStream(this.bos);
