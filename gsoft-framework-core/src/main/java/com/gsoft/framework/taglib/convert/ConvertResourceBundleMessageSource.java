 ...
 *
 */
public class ConvertResourceBundleMessageSource extends ReloadableResourceBundleMessageSource {

	private static final String CONVERT_PROP_PREFIX = "converts.";

	private final Map<String, Convert<String>> cachedConverts;

	public ConvertResourceBundleMessageSource() {
		this.cachedConverts = new HashMap<String, Convert<String>>();
	}
