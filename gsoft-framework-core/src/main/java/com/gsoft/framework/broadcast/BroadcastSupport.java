package com.gsoft.framework.broadcast;
...
/**
 * Sends broadcast event that something happens with given {@link Object}. For
...
public final class BroadcastSupport {
	 ...
	 */
	private final Map<Object, List<Object>> m_targetToListeners = Collections
			.synchronizedMap(new HashMap<Object, List<Object>>());
	...
	/** 
	 * 添加监听（听众）
	 * @param target 添加监听的对象
	 * @param listenerImpl 添加的监听实现方法
	 */
	public void addListener(Object target, Object listenerImpl) {
	 ...
	 * 删除监听（听众）
	 * @param target 添加监听的对象
	 * @param listenerImpl 添加的监听
	 */
	public void removeListener(Object target, Object listenerImpl) {
		Class<?> listenerClass = getListenerClass(listenerImpl);
	 ...
	 * @noreference
	 */
	public void targetListener(Object oldTarget, Object newTarget) {
	...
	/**
	 * When we remove {@link Object}'s from their parent, so exclude them from
	 * hierarchy, or these {@link Object}'s are just not included into hierarchy
	 * during parsing; we should remove any broadcast listeners, registered by
	 * these {@link Object}'s.
	 * 
	 * @noreference
	 */
	// public void cleanUpTargets(Object root) {
	// List<Object> targets = new
	// ArrayList<Object>(m_targetToListeners.keySet());
	 ...
	 *         {@link List}, but not <code>null</code>.
	 */
	private List<Object> getTargetListeners(Object target) {
