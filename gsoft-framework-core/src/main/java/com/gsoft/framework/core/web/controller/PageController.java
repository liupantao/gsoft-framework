...
public class PageController extends BaseController {
	...
	public ModelAndView index(@PathVariable("pagePath") String pagePath, @PathVariable("pageId") String pageId,
	...
	private ModelMap findPageModelMap(HttpServletRequest request, String pagePath, String pageId) {
		...
		try {
			pageAttribute = context.getBean(pagePath, IPageModel.class);
