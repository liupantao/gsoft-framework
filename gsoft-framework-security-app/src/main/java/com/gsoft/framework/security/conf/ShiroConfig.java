...
import com.gsoft.framework.security.authc.ApiGatewayAuthenticationFilter;
import com.gsoft.framework.security.authc.ShiroPermissionsAuthorizationFilter;
import com.gsoft.framework.security.authc.ShiroRolesAuthorizationFilter;
...
import com.gsoft.framework.security.session.SessionEntityDao;
...
public class ShiroConfig {
	...
	public SessionDAO getSessionDao() {
		SessionEntityDao cacheSessionDao = new SessionEntityDao(cacheManager, sessionTimeOut * 1000);
	...
	private Map<String, Filter> getFilters() {
		...
		ApiGatewayAuthenticationFilter formAuthenticationFilter = new ApiGatewayAuthenticationFilter();
		...
		// filters.put("anyRole", formAuthenticationFilter);
